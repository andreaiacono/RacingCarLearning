...
public class ReinforcementLearningManager implements MDP<RacingState, Integer, DiscreteSpace> {
    ...
    public static QLearning.QLConfiguration TOY_QL =
            new QLearning.QLConfiguration(
                    ...
                    32,    //size of batches
                    100,   //target updatePosition (hard)
    ...
    public static DQNFactoryStdDense.Configuration RacingCircuitNeuralNetwork  =
...
//    }
    ...
    public Command getOutput(byte[] currentFrame) {

//        byte[] delta = computeDelta(oldFrame, currentFrame);
    ...
    public ObservationSpace<RacingState> getObservationSpace() {
        return null;
    }
    ...
    public StepReply<RacingState> step(Integer integer) {
        return null;
    }
    ...
    public MDP<RacingState, Integer, DiscreteSpace> newInstance() {
        return null;
    }
}
